class Calculator{
    ...
    float substraction(float operand_1,float operand_2,float operand_3){
        return(operand_1 - operand_2);
    }
     ...
     */
    float division(float operand_1,float operand_2,float operand_3){
        return(operand_1 / operand_2);
    }
    ...
    public static void main(String[] args){
        ...
        float sub_result=calc.substraction(operand_1,operand_2,operand_3);
        ...
        float div_result=calc.division(operand_1,operand_2,operand_3);
